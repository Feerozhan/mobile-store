            ...
            <div className="md:w-1/2 bg-gradient-to-br from-blue-600 to-blue-800 p-8 text-white">
              ...
              <div className="mb-6 flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-blue-200">freestore@gmail.com</p>
                </div>
              </div>
              ...
              <div className="mb-6 flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="mt-1 text-blue-200">+92 123-4567</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  <h3 className="text-lg font-medium text-blue-100">Address</h3>
                  <p className="mt-1 text-blue-200">123 Business , Suite 410<br />pakistan,CA 107</p>
                </div>
              </div>
            </div>
